...
function CategoriesStrip() {
    return (
        <section className="border-b border-amber-100/80 bg-white py-14">
    ...
    return (
        <section className="bg-[#FFFBF5] py-16 md:py-20">
            <div className="mx-auto max-w-7xl px-4 md:px-8">
                <div className="mb-10 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                    <div>
                        <div className="mb-3 inline-flex items-center gap-2 rounded-full border border-orange-200 bg-orange-50 px-4 py-1.5">
                            <span className="flex h-2 w-2 rounded-full bg-orange-500 shadow-[0_0_6px_rgba(255,92,26,0.7)]" />
                    ...
                    <Link
                        href="/menu"
                        className="group flex shrink-0 items-center gap-2 self-start rounded-full border border-stone-200 bg-white px-5 py-2.5 text-sm font-bold text-stone-600 shadow-sm transition-all hover:border-orange-300 hover:bg-orange-50 hover:text-orange-600 sm:self-auto"
                    >
                        View Full Menu
                ...
                {/* Bottom nudge */}
                <div
                    className="mt-10 flex flex-col items-center gap-3 rounded-3xl border border-amber-100/80 p-6 text-center md:flex-row md:justify-between md:text-left"
                    style={{ background: "linear-gradient(135deg, #fffbf5 0%, #fff7ed 100%)" }}
                >
                    <div>
                        <p className="font-black text-stone-900">Hungry for more?</p>
                        <p className="text-sm text-stone-500">
                            Browse our full menu of 100+ items across all categories.
                        </p>
                    </div>
                    <Link
                        href="/menu"
                        className="inline-flex shrink-0 items-center gap-2 rounded-full px-7 py-3 text-sm font-black text-white shadow-md transition-all hover:brightness-105 active:scale-95"
                        style={{
            ...
            : [
                  {
                      ...
                      userName: "Priya S.",
                      rating: 5,
                      comment: "Best cold coffee I've had in ages. Ordering online was incredibly smooth!",
                  ...
                  },
                  {
                      ...
                      userName: "Ananya K.",
                      rating: 5,
                      comment: "Love the combo deals and ice creams. The site is so smooth — premium feel!",
                      createdAt: new Date().toISOString(),
                  },
              ];

    return (
        <section className="border-t border-amber-100 bg-white py-16 md:py-20">
            <div className="mx-auto max-w-7xl px-4 md:px-8">
                <div className="mb-10 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                    <div>
                        <p className="mb-1 text-[11px] font-black uppercase tracking-[0.22em] text-orange-500">
                    ...
                    <Link
                        href="/reviews"
                        className="group hidden items-center gap-2 text-sm font-bold text-stone-500 transition-colors hover:text-orange-600 md:inline-flex"
                    >
                        All Reviews{" "}
                        <ArrowRight size={13} className="transition-transform group-hover:translate-x-0.5" />
                    </Link>
                ...
                <div className="grid gap-4 md:grid-cols-3">
                    {displayReviews.map(({ _id, userName, rating, comment }, i) => {
                        ...
                        return (
                            <div
                                key={_id}
                                className="flex flex-col rounded-3xl border border-stone-100 bg-[#FFFBF5] p-5 shadow-sm transition-all hover:border-orange-200 hover:shadow-lg hover:shadow-orange-100/50"
                            >
                                {/* Stars */}
                                ...
                                <p className="flex-1 text-sm leading-7 text-stone-600">&ldquo;{preview}&rdquo;</p>

                                {isTruncated && (
                                    <Link
                                        href="/reviews"
                                        className="mt-1.5 flex w-fit items-center gap-0.5 text-[12px] font-bold text-orange-500 transition-colors hover:text-orange-600"
                                    >
                                        Read more <ChevronRight size={12} strokeWidth={2.5} />
                                    </Link>
                                )}

                                <div className="mt-4 flex items-center gap-2.5 border-t border-stone-100 pt-4">
                                    <div
                ...
                <div className="mt-6 flex justify-center md:hidden">
                    <Link
                        href="/reviews"
                        className="flex items-center gap-2 rounded-full border border-stone-200 bg-white px-5 py-2.5 text-sm font-bold text-stone-600 shadow-sm transition-all hover:border-orange-300 hover:bg-orange-50 hover:text-orange-600"
                    >
        ...
        <section className="bg-[#FFFBF5] pb-20 pt-4">
            <div className="mx-auto max-w-7xl px-4 md:px-8">
                <div
                    ...
                    style={{
                        background: "linear-gradient(135deg, #FF5C1A 0%, #FF8C42 55%, #FFB347 100%)",
                    }}
                >
                    {/* Dot texture */}
                    <div
                    ...
                    <div className="pointer-events-none absolute -left-10 bottom-0 h-40 w-40 rounded-full bg-black/10 blur-2xl" aria-hidden="true" />
                    ...
                    <div className="relative flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
                        <div className="max-w-lg">
                            ...
                            >
                                ...
                                <span className="text-white/85">amazing?</span>
                            </h2>
                            <p className="mt-2 text-sm leading-relaxed text-white/80">
                                Fresh food, fast delivery, smooth online ordering — the FoodKnock experience starts the moment you tap.
                            </p>
                        </div>
                        ...
                        <div className="flex shrink-0 flex-col gap-3">
                            <Link
                                href="/menu"
                                className="inline-flex items-center justify-center gap-2 rounded-full bg-white px-8 py-3.5 text-sm font-black text-orange-600 shadow-lg transition-all hover:bg-orange-50 active:scale-95"
                            >
                                Start Your Order <ArrowRight size={14} />
                            </Link>
                            <Link
                                href="/contact"
                                className="inline-flex items-center justify-center gap-2 rounded-full border-2 border-white/30 bg-white/10 px-8 py-3.5 text-sm font-bold text-white backdrop-blur-sm transition-all hover:bg-white/20"
                            >
                                Get in Touch
                            </Link>
                        </div>
