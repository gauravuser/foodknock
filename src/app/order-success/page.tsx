...
// FoodKnock — premium order confirmation page.
// No WhatsApp button. Rider calls directly when out for delivery.
// Shows: animated success, order ID, delivery steps, earn reminder, CTA buttons.
...
export default function OrderSuccessPage() {
    ...
    const [pointsEarned] = useState(Math.floor(Math.random() * 30) + 10); // placeholder — real value from order total
            ...
            <main className="min-h-screen bg-[#FAFAF9]">
                ...
                <div className="relative mx-auto max-w-2xl px-4 py-12 md:py-16">
                    ...
                    <div className={`flex flex-col gap-4 transition-all duration-700 delay-200 ${visible ? "translate-y-0 opacity-100" : "translate-y-6 opacity-0"}`}>
                        ...
                        {/* 2 · Delivery contact notice (NO WhatsApp) */}
                        ...
                        <div className="flex flex-col gap-3 pt-2 sm:flex-row">
                            ...
                            <Link href="/menu" className="group flex flex-1 items-center justify-center gap-2.5 rounded-2xl border border-stone-200 bg-white px-6 py-4 text-[14px] font-black text-stone-700 shadow-sm transition-all hover:border-orange-300 hover:bg-orange-50 active:scale-[0.98]">
                        ...
                        <div className="flex items-center gap-4 rounded-3xl border border-stone-100 bg-white px-5 py-4 shadow-sm">
                            ...
                            <div>
                                ...
                                <p className="text-[11px] text-stone-500">
                                    Real-time tracking · faster checkout · app-only deals. <span className="font-bold text-orange-500">iOS & Android.</span>
                                </p>
                            </div>
                        </div>
